...
const HomePage = ({ photos }) => {
  ...
  return (
    <>
      <div className="selection:bg-[#735e40]">
        {/* navbar */}
        <Navbar />
              ...
              <form action="submit">
                <div className="flex flex-col space-y-5">
                  ...
                  <div className="text-[17px]">
                    ...
                    marketing and commercial communications by savora, being
                    aware that I will be able to withdraw my consent at any
                    time.
                  </div>
                  <button
        ...
        <section className="w-full py-16 flex flex-col md:justify-center md:flex-row md:items-center space-y-11 bg-[#8E9E8B] text-[#374B42] shadow-2xl">
          ...
          <div className="mx-6 space-y-5 md:w-[50vw]">
            ...
            <p className="text-[18px] md:text-[20px]">
              Savora celebrates the art of fine dining — blending timeless
              recipes with a touch of modern elegance. Every dish is a tribute
              to flavor, crafted from the finest ingredients and elevated
              through creativity and care. We believe that food should not only
              satisfy hunger but awaken the senses, spark connection, and tell a
            ...
            <p className="text-[18px]">
              ...
              designed to evoke warmth, comfort, and sophistication in every
              bite.
            </p>
            <p className="text-[18px]">
              At Savora, dining is more than a meal — it’s an experience. A
              moment to slow down, to indulge, and to share joy around the
              table. Whether it’s your first visit or your fiftieth, our promise
              is the same: to deliver a taste of timeless beauty, served with
              grace and soul.
            </p>
          </div>
        </section>
        ...
        >
          ...
          <p className="text-gray-700 text-lg max-w-xl mx-6">
            Because every moment deserves to be savored. Book your seat and let
